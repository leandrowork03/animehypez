    ...
    return (
      <Container>
        <main className="flex flex-col w-full h-screen items-center justify-center">
          <h1
            className="font-black text-center text-2xl m-4 text-orange-600 text-3xl"
  ...
  return (
    <div>
      ...
      <header className="px-10 mt-1 bg-black pt-1 pb-1">
        ...
        <div className="pt-20">
          <section
            className=" p-4 rounded-lg max-w-3xl mx-auto flex justify-center items-center gap-2 "
            style={{ backgroundColor: "rgba(0, 0, 0, 0.750)" }}
          >
            <input
              placeholder="Search"
              value={search}
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <b className="mx-1">/</b>
                    <strong className="text-shadow-rose-400">
                      {item.title_japanese}
                    </strong>
                  </div>
      ...
      <footer className="bg-zinc-900 text-white text-center py-4 mt-10">
        <p className="text-sm">
          © {new Date().getFullYear()} Desenvolvido por <strong>Leandro</strong>{" "}
